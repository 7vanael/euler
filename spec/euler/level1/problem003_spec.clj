...
(describe "Euler Problem #3"
  ...
  (it "Removes a factor 3 from a number divisible by 3"
      (should= 1 (remove-factor 3 3))
      (should= 2 (remove-factor 6 3))
      (should= 1 (remove-factor 9 3))
      (should= 4 (remove-factor 12 3))
      (should= 5 (remove-factor 15 3))
      (should= 2 (remove-factor 18 3))
      (should= 1 (remove-factor 27 3))
      )
  (it "Removes a factor 2 from a number divisible by 2"
      (should= 1 (remove-factor 2 2))
      (should= 1 (remove-factor 4 2))
      (should= 3 (remove-factor 6 2))
      (should= 5 (remove-factor 10 2))
      (should= 7 (remove-factor 14 2))
      (should= 1 (remove-factor 16 2))
      )
